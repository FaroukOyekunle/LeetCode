namespace DailyQuestion
{
    public class CheckifStringsCanbeMadeEqualWithOperationsI
    {
        ...
        {
            char[] firstStringEvenIndexedCharacters = new char[] { firstString[0], firstString[2] };

            char[] firstStringOddIndexedCharacters = new char[] { firstString[1], firstString[3] };

            char[] secondStringEvenIndexedCharacters = new char[] { secondString[0], secondString[2] };

            char[] secondStringOddIndexedCharacters =  new char[] { secondString[1], secondString[3] };
